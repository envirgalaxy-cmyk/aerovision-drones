import { r as reactExports, j as jsxRuntimeExports, L as Link, a as useRouterState } from "./index-DLb34WgJ.js";
/**
...
const Crosshair = createLucideIcon("crosshair", __iconNode$5);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-card border-t border-border mt-auto", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-4 gap-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:col-span-2 space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(Link, { to: "/", className: "flex items-center gap-2.5 w-fit group", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-9 h-9 rounded-sm border border-primary/50 bg-primary/10 flex items-center justify-center group-hover:shadow-glow transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Crosshair, { className: "w-5 h-5 text-primary" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-xl text-foreground", children: [
            "Aero",
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Vision" })
          ] })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground text-sm leading-relaxed max-w-xs", children: "Advanced aerial intelligence solutions. Precision inspections, mapping, surveillance, and cinematography for industries that demand the highest standard." }),
      ...
      Object.entries(footerLinks).map(([group, links]) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h4", { className: "font-display font-semibold text-sm text-foreground tracking-wider uppercase", children: group }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-10 pt-6 border-t border-border flex flex-col sm:flex-row items-center justify-between gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-xs", children: [
        "© ",
        year,
        " AeroVision Drones. All rights reserved."
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-muted-foreground text-xs", children: [
...
const variants$1 = {
  primary: "bg-primary text-primary-foreground border border-primary/60 shadow-glow animate-glow-pulse hover:shadow-glow-intense hover:brightness-110",
  secondary: "bg-secondary text-secondary-foreground border border-border hover:bg-secondary/80 hover:border-primary/40 hover:shadow-glow",
  ghost: "bg-transparent text-foreground border border-transparent hover:border-primary/30 hover:bg-primary/10 hover:shadow-glow",
  outline: "bg-transparent text-primary border border-primary/50 hover:bg-primary/10 hover:border-primary hover:shadow-glow",
  danger: "bg-destructive/10 text-destructive border border-destructive/40 hover:bg-destructive/20"
};
const sizes = {
  ...
  if (as === "a" && href) {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs(
      motion.a,
      {
        ...
        className: classes,
        children: [
          loading ? /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "animate-spin mr-1", children: "⟳" }) : null,
          children
        ]
      }
    );
...
function Navigation() {
  ...
  const prevPath = reactExports.useRef(currentPath);
  reactExports.useEffect(() => {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      motion.header,
      {
        ...
        className: cn(
          ...
          scrolled ? "bg-card/95 backdrop-blur-md border-b border-border shadow-elevated-dark" : "bg-transparent border-b border-transparent"
        ),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between h-16", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Link,
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-8 h-8 rounded-sm border border-primary/50 bg-primary/10 flex items-center justify-center group-hover:shadow-glow transition-smooth", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Crosshair, { className: "w-4 h-4 text-primary" }) }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "font-display font-bold text-lg tracking-wide text-foreground", children: [
                  "Aero",
                  /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary", children: "Vision" })
                ] })
              ]
              ...
              children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                Link,
                {
                  ...
                  className: cn(
                    ...
                    currentPath === link.to ? "text-primary bg-primary/10" : "text-muted-foreground hover:text-foreground hover:bg-secondary/60"
                  ),
                  children: link.label
                },
                link.to
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", className: "hidden md:block", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "primary",
                size: "sm",
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, children: mobileOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(
                  motion.span,
                  {
                  ...
                  motion.span,
                  {
                    ...
                    exit: { rotate: -90, opacity: 0 },
                    transition: { duration: 0.15 },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(Menu, { className: "w-4 h-4 text-foreground" })
                  },
                  "menu"
                ) })
              }
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        motion.nav,
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col gap-1 p-4 flex-1", children: navLinks.map((link, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              motion.div,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Link,
                  {
                    ...
                    className: cn(
                      ...
                      currentPath === link.to ? "text-primary bg-primary/10 border border-primary/20" : "text-muted-foreground hover:text-foreground hover:bg-secondary/50"
                    ),
                    children: link.label
                  }
                )
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4 border-t border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Link, { to: "/contact", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                variant: "primary",
                size: "md",
...
function Layout({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen flex flex-col bg-background", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("main", { className: cn("flex-1 pt-16", !fullWidth && "w-full", className), children }),
    !noFooter && /* @__PURE__ */ jsxRuntimeExports.jsx(Footer, {})
  ] });
}
const variants = {
