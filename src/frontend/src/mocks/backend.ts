  ...
  getAllProjects: async () => [
    {
      ...
      description:
        "Comprehensive aerial documentation of a 42-story residential tower from groundbreaking to topping out. Bi-weekly photo and video reports delivered to project stakeholders.",
      clientIndustry: "Construction",
      results:
        "Saved 15% on site inspection costs, identified 3 safety issues before escalation, delivered 48 progress reports over 24 months.",
      hasBeforeAfter: true,
    },
    {
      id: BigInt(2),
      ...
      description:
        "Full NDVI and thermal mapping of a 500-acre vineyard in Napa Valley to identify irrigation deficiencies and early disease onset across multiple vine varieties.",
      clientIndustry: "Agriculture",
      results:
        "Detected irrigation failures in 12% of fields before visible symptoms appeared, increasing yield by an estimated 8% through targeted intervention.",
      hasBeforeAfter: true,
    },
    {
      id: BigInt(3),
      ...
      description:
        "Cinematic aerial and ground-level video production for a $14M oceanfront property listing.",
      clientIndustry: "Real Estate",
      results:
        "Property sold within 11 days of listing — 60% faster than comparable properties. Listing video garnered 85,000 views on social media.",
    ...
    },
    {
      ...
      description:
        "Nighttime and daytime perimeter surveillance of a 200-acre logistics facility using thermal and RGB cameras.",
      clientIndustry: "Security",
      results:
        "Identified 7 perimeter blind spots, reduced security patrol routes by 30%.",
      hasBeforeAfter: false,
    },
    {
      id: BigInt(5),
      ...
      description:
        "Detailed 3D photogrammetric survey of a 12-mile highway corridor including bridges, overpasses, and retaining walls.",
      clientIndustry: "Infrastructure",
      results:
        "Reduced inspection time by 70% versus traditional ground teams, produced sub-centimeter accuracy point clouds.",
      hasBeforeAfter: true,
    },
    {
      id: BigInt(6),
      ...
      serviceType: "Cinematic Filming",
      description:
        "Aerial cinematography for a Hollywood action film's climactic desert chase sequence. Operated custom-rigged heavy-lift drones with RED camera payloads.",
      clientIndustry: "Film & Entertainment",
      results:
        "Delivered 14 approved aerial shots used in the final cut, completed all shots within schedule.",
      hasBeforeAfter: false,
    },
  ],
  getAllServices: async () => [
    {
      ...
      description:
        "Stunning high-resolution aerial imagery captured with professional-grade cameras and precision-stabilized gimbals.",
      features: [
    ...
    },
    {
      ...
      slug: "3d-mapping",
      description:
        "Centimeter-accurate photogrammetric 3D models and topographic surveys delivered as point clouds, orthomosaics, and digital elevation models.",
      features: [
    ...
    },
    {
      ...
      description:
        "Radiometric thermal imaging for solar panels, rooftops, pipelines, electrical infrastructure, and crop health assessment.",
      features: [
    ...
    },
    {
      ...
      slug: "land-surveying",
      description:
        "FAA-compliant aerial land surveys for boundary determination, construction stakeout, and as-built documentation.",
      features: [
    ...
    },
    {
      ...
      description:
        "Rapid deployment aerial surveillance for large-scale security operations, event monitoring, perimeter assessment, and search-and-rescue support.",
      features: [
    ...
    },
    {
      ...
      description:
        "Hollywood-quality aerial cinematography for film, television, commercials, and branded content.",
      features: [
  ...
  getAllIndustries: async () => [
    {
      ...
      slug: "construction",
      description:
        "From site surveys to progress documentation and safety monitoring, our drones give construction teams a bird's-eye view of every project phase.",
      useCases: [
    ...
    },
    {
      ...
      slug: "agriculture",
      description:
        "Precision agriculture starts from the sky. NDVI mapping, thermal crop health analysis, and irrigation monitoring help farmers maximize yield.",
      useCases: [
    ...
    },
    {
      ...
      slug: "real-estate",
      description:
        "Properties sell faster and for more when showcased from the air. Our real estate drone services deliver stunning imagery and video.",
      useCases: [
    ...
    },
    {
      ...
      slug: "security",
      description:
        "Aerial surveillance platforms extend the reach of security teams, providing real-time intelligence and documentation.",
      useCases: [
    ...
    },
    {
      ...
      description:
        "Aerial cinematography has transformed storytelling. Our cinema-grade drone platforms deliver signature aerial shots that define modern production.",
      useCases: [
    ...
    },
    {
      ...
      slug: "infrastructure",
      description:
        "Bridges, power lines, pipelines, and highways require regular inspection. Our drones safely access difficult structures.",
      useCases: [
  ...
  getCoverageZones: async () => [
    {
      ...
      region: "West Coast",
      description:
        "Full coverage across LA County, Orange County, and the Inland Empire. FAA Part 107 waivers held for Class B, C, and D airspace.",
      lat: 34.0522,
      lng: -118.2437,
    },
    {
      ...
      region: "West Coast",
      description:
        "Coverage across San Francisco, the East Bay, Silicon Valley, and the Peninsula with LAANC authorization.",
      lat: 37.7749,
      lng: -122.4194,
    },
    {
      ...
      region: "East Coast",
      description:
        "Operations across the NYC five boroughs, New Jersey, Long Island, and Connecticut.",
      lat: 40.7128,
      lng: -74.006,
    },
    {
      ...
      description:
        "Coverage of the entire DFW Metroplex and surrounding counties with expedited permitting.",
      lat: 32.7767,
      lng: -96.797,
    },
    {
      ...
      region: "Midwest",
      description:
        "Coverage across Cook County, the North Shore, DuPage, and the Illinois–Indiana corridor.",
      lat: 41.8781,
      lng: -87.6298,
    },
  ],
