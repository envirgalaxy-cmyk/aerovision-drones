import type { CoverageZone, Industry, Project, Service } from "@/types";
...
export const projects: Project[] = [
  {
    ...
    description:
      "Complete structural inspection of the Golden Gate Bridge using LiDAR-equipped drones, delivering 4K photogrammetry models and thermal imaging reports for deferred maintenance planning.",
    ...
    client: "Caltrans",
    results:
      "Identified 14 maintenance-critical zones, reducing inspection time by 70%",
    featured: true,
    hasBeforeAfter: true,
    beforeImage: "/assets/images/project-bridge.jpg",
    afterImage: "/assets/images/project-bridge-after.jpg",
    challenge:
      "Traditional rope-access inspections required multi-week lane closures and posed significant safety risks to inspectors working at height over open water.",
    approach:
      "Deployed a fleet of LiDAR-equipped drones with millimeter-precision sensors, capturing 1.2 billion data points in a single 6-hour operation without disrupting traffic flow.",
  },
  {
    id: "farm-mapping-precision",
    title: "Central Valley Precision Agriculture Mapping",
    description:
      "Multispectral aerial mapping across 12,000 acres of farmland to generate NDVI crop health indices, irrigation analysis, and yield prediction models for a consortium of agricultural producers.",
    ...
    results:
      "Increased yield by 18%, reduced water usage by 24% through precision irrigation",
    featured: true,
    hasBeforeAfter: true,
    beforeImage: "/assets/images/project-farm.jpg",
    afterImage: "/assets/images/project-farm-after.jpg",
    challenge:
      "Farmers across 12,000 acres lacked granular field-level data, resulting in uniform fertilizer and irrigation application that wasted resources and left yield potential unrealized.",
    approach:
      "Flew multispectral missions bi-weekly throughout the growing season, generating NDVI, NDRE, and thermal layers processed into field-prescription maps compatible with variable-rate application equipment.",
  },
  {
    id: "solar-thermal-inspection",
    title: "Mojave Solar Farm Thermal Inspection",
    description:
      "Thermal drone inspection of 480MW solar installation, identifying underperforming panels and hotspot anomalies across 2,800 acres, enabling targeted maintenance and energy recovery.",
    industry: "Energy",
    serviceType: "Inspection",
    location: "Mojave, CA",
    year: 2023,
    ...
    results:
      "Recovered 3.2MW of lost generation through targeted panel replacement",
    featured: true,
    hasBeforeAfter: true,
    beforeImage: "/assets/images/project-solar.jpg",
    afterImage: "/assets/images/project-solar-after.jpg",
    challenge:
      "Manual ground-level inspection of 1.4 million solar panels across 2,800 acres would take 18 months and cost over $2M, with significant revenue loss during downtime.",
    approach:
      "Executed systematic thermal flyovers at dawn and dusk (optimal thermal delta conditions) using radiometric FLIR cameras, auto-flagging hotspot anomalies with GPS coordinates for maintenance crews.",
  },
  {
    id: "urban-surveillance-network",
    title: "Downtown Security Surveillance Network",
    description:
      "Deployment of autonomous drone patrol network across a 4-block commercial district, integrating AI-powered threat detection, real-time feeds, and incident alerting for private security operations.",
    industry: "Security",
    ...
    results:
      "40% reduction in security incidents, 24/7 automated monitoring coverage",
    featured: false,
    challenge:
      "A high-traffic commercial district required 24/7 perimeter monitoring but lacked the budget to staff ground security around the clock across the entire area.",
    approach:
      "Integrated three autonomous drone-in-a-box units with AI-powered behavior analysis, geofencing triggers, and encrypted live feeds streamed to a central security operations center.",
  },
  {
    id: "coastal-film-production",
    title: "Pacific Coast Cinematic Campaign",
    description:
      "High-altitude 6K aerial cinematography for a premium automotive commercial, capturing sweeping coastal highways and mountain terrain with RED camera-equipped cinematic drones.",
    industry: "Film & Media",
    ...
    featured: false,
    challenge:
      "The production required smooth, cinematic tracking shots along a narrow coastal highway with dramatic cliff edges — conditions that make traditional helicopter-mounted cameras impractical and dangerous.",
    approach:
      "Deployed a RED Komodo-equipped DJI Inspire 3 with 3-axis gimbal stabilization, executing precisely choreographed follow-cam routes at 1m/s tracking speed for silky 6K footage.",
  },
  {
    id: "3d-city-mapping",
    title: "San Jose Smart City 3D Mapping",
    description:
      "Complete 3D point cloud and mesh generation of downtown San Jose using LiDAR and photogrammetry drones, feeding GIS datasets for urban planning, infrastructure design, and flood modeling.",
    ...
    results:
      "Delivered 1.2TB point cloud dataset with sub-5cm accuracy for 12 city blocks",
    featured: false,
    challenge:
      "The city's urban planning department needed an up-to-date 3D digital twin of the downtown core for flood risk modeling, but existing photogrammetry data was 7 years old.",
    approach:
      "Coordinated multi-drone LiDAR and RGB missions across 6 operational days, processing 1.2TB of raw capture into GIS-ready point clouds and textured meshes via Pix4D and ArcGIS pipelines.",
  },
];
...
export const services: Service[] = [
  {
    ...
    description:
      "Advanced aerial inspection services using LiDAR, thermal, and high-resolution cameras to identify structural issues, maintenance needs, and safety hazards with unmatched accuracy.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Full-coverage aerial mapping producing 2D orthomosaics, 3D point clouds, and digital elevation models for engineering, planning, and environmental analysis.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Continuous aerial surveillance and autonomous patrol solutions integrated with AI-powered threat detection for perimeter security, event monitoring, and critical asset protection.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Cinematic-grade aerial photography and videography for film, advertising, real estate, and brand campaigns using industry-leading camera platforms.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Multispectral and hyperspectral drone surveys for ecological assessment, vegetation health mapping, wildlife tracking, and environmental impact analysis.",
    longDescription:
  ...
  },
  {
    ...
    description:
      "Rapid-deployment drone operations for search & rescue, disaster assessment, firefighting support, and real-time situational awareness during critical incidents.",
    longDescription:
...
export const industries: Industry[] = [
  {
    ...
    description:
      "Accelerate project timelines and reduce inspection costs for bridges, highways, pipelines, and large-scale construction sites with aerial intelligence.",
    icon: "Building2",
    useCases: [
  ...
  },
  {
    ...
    description:
      "Precision agriculture solutions delivering crop health data, irrigation optimization, and yield forecasts that transform how farms operate at scale.",
    icon: "Sprout",
    useCases: [
  ...
  },
  {
    ...
    description:
      "Thermal and visual inspections of solar farms, wind turbines, power lines, and substations that maximize uptime and reduce maintenance costs.",
    icon: "Zap",
    useCases: [
  ...
  },
  {
    ...
    description:
      "Autonomous surveillance, perimeter monitoring, and tactical situational awareness for private security, government, and critical infrastructure protection.",
    icon: "ShieldCheck",
    useCases: [
  ...
  },
  {
    ...
    description:
      "Professional aerial cinematography and photography for productions, advertising campaigns, and premium real estate marketing that demands stunning visuals.",
    icon: "Camera",
    useCases: [
  ...
  },
  {
    ...
    description:
      "Comprehensive mapping, modeling, and monitoring solutions for city planners, government agencies, and public infrastructure managers.",
    icon: "Landmark",
    useCases: [
...
export const coverageZones: CoverageZone[] = [
  {
    ...
    radius: 80,
    description:
      "Full operational coverage including San Francisco, Oakland, San Jose, and surrounding counties.",
    active: true,
  },
  {
    id: "los-angeles",
    ...
    radius: 120,
    description:
      "Coverage across LA, Orange County, Riverside, and the Inland Empire.",
    active: true,
  },
  {
    id: "central-valley",
    ...
    radius: 150,
    description:
      "Agricultural and industrial operations across the entire Central Valley corridor.",
    active: true,
  },
  {
    id: "nevada-corridor",
    ...
    radius: 100,
    description:
      "Las Vegas metro area and surrounding desert regions, including commercial and security contracts.",
    active: true,
  },
  {
    ...
    radius: 200,
    description:
      "Expanding coverage across Portland, Seattle, and the wider Pacific Northwest region.",
    active: false,
  },
];
